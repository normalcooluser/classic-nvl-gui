...
screen content_warning():
    ...
    frame:
        ...
        vbox:
            ...
            text _("this is just a basic content warning screen you can put in your project!") text_align 0.5 xalign 0.5
            ...
            text _("by clicking confirm, you hereby agree that you are willing and able to interact with the content in this game.") text_align 0.5 xalign 0.5
