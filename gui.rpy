...
define gui.accent_color = '#002937'
...
define gui.idle_small_color = '#989797'
...
define gui.text_font = gui.preference("font", default="sazanami-gothic.ttf")

## Set a completely custom variable tied to the font size to avoid
## having both typeface buttons highlighted.
default persistent.typeface = "sazanami-gothic.ttf"

## The font used for character names.
define gui.name_text_font = gui.preference("font", default="sazanami-gothic.ttf")

## The font used for out-of-game text.
define gui.interface_text_font = gui.preference("font", default="sazanami-gothic.ttf")

## The font used for hyperlink text. Should be the same as gui.interface_text_font.

define gui.hyperlink_text_font = gui.preference("font", default="sazanami-gothic.ttf")
...
define gui.nvl_borders = Borders(0, 0, 20, 0)

## The maximum number of NVL-mode entries Ren'Py will display. When more entries
## than this are to be show, the oldest entry will be removed. TODO: make it so the page automatically clears once you hit the list length limit
