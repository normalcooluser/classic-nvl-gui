...
screen navigation():
    ...
    vbox:
        ...
        if renpy.variant("pc") or (renpy.variant("web") and not renpy.variant("mobile")):
            ...
            #uncomment if u wanna add extras. or js remove...im not ur mom. TODO just make this fit withg the demo and be enabled
            #by default. im tired bro i wanna get this out
            ...
            hbox:
                ...
                vbox:
                    ...
                    if renpy.variant("pc"):
                        ...
                        ## option only shows if the user is playing on a PC. it also has issue working on linux? i think
                        textbutton _("Self-Voicing") action Preference("self voicing", "toggle") alt "Toggle Self-Voicing"

                vbox:
                    style_prefix "radio"
                    label _("Typeface")
                    textbutton _("Sazanami Gothic") action [gui.SetPreference("font", "sazanami-gothic.ttf"), gui.SetPreference("size", 67), SetVariable("persistent.typeface", "sazanami-gothic")] alt "Change font to Sazanami Gothic"
                    textbutton _("{font=gui/font/OpenDyslexic-Regular.otf}{size=40}OpenDyslexic{/size}{/font}") action [gui.SetPreference("font", "gui/font/OpenDyslexic-Regular.otf"), gui.SetPreference("size", 39), SetVariable("persistent.typeface", "OpenDyslexic")] alt "Change font to OpenDyslexic"
#TODO: make it so we can do font size changes with no added struggle, make it so settings fonts change too maybe idk abt that one
